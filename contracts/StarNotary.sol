...
contract StarNotary is ERC721 {
    ...
    string public name = "Andy Star Collection";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            msg.sender == address1 || msg.sender == address2,
            "you cannot exchange stars you do not own"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            ...
            "you cannot transfer star you do not own"
        );
